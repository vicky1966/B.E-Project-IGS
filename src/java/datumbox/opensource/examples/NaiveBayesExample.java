...
public class NaiveBayesExample {
    ...
    public static String classify(String input) throws IOException {
        ...
        trainingFiles.put("java", NaiveBayesExample.class.getResource("training.language.en.txt"));
        trainingFiles.put("sql", NaiveBayesExample.class.getResource("training.language.fr.txt"));
